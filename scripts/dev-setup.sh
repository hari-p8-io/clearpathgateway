...
FAST_INWARD_PROCESSOR_URL=http://fast-inward-clearing-processor:8080
FAST_OUTWARD_PROCESSOR_URL=http://fast-outward-clearing-processor:8080
FAST_SENDER_SERVICE_URL=http://fast-sender-service:8080
FAST_LIQUIDITY_SERVICE_URL=http://fast-liquidity-service:8080
FAST_AVAILABILITY_SERVICE_URL=http://fast-availability-service:8080
